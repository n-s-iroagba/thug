import { Souvenir, SouvenirCreationAttributes } from "../models/Souvenir";
import { Celebrity } from "../models/Celebrity";

export class SouvenirsService {

  static async createSouvenir(data:SouvenirCreationAttributes): Promise<Souvenir> {
    const {images,celebrityId,name,description} =data
    try {
